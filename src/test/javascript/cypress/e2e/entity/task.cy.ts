...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('but aha');
      cy.get(`[data-cy="title"]`).should('have.value', 'but aha');

      cy.get(`[data-cy="description"]`).type('geez');
      cy.get(`[data-cy="description"]`).should('have.value', 'geez');
