...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'aee6c73d-8471-4efa-b374-631c9d987605' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('58d11f6e-043a-49ef-a639-f505c942a1d0');
      cy.get(`[data-cy="name"]`).should('have.value', '58d11f6e-043a-49ef-a639-f505c942a1d0');
