...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Central Optimization Developer');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Central Optimization Developer');

      cy.get(`[data-cy="minSalary"]`).type('18686');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '18686');

      cy.get(`[data-cy="maxSalary"]`).type('16488');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '16488');
