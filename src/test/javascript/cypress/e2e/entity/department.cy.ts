...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'however' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('carefree depot utterly');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'carefree depot utterly');
