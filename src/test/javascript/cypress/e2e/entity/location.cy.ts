...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('tenderly');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'tenderly');

      cy.get(`[data-cy="postalCode"]`).type('between smog phew');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'between smog phew');

      cy.get(`[data-cy="city"]`).type('South Dallastown');
      cy.get(`[data-cy="city"]`).should('have.value', 'South Dallastown');

      cy.get(`[data-cy="stateProvince"]`).type('procrastinate delectable embarrassment');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'procrastinate delectable embarrassment');
